...
DIR_TOY_DATASET = "/home/sakae/Windows/dataset/hypernym_detection/toy_dataset_supervised_ver3"
...
cfg_hyponymy_relation_datasets = {
    ...
    "hyponymy-triple-dev": {
        ...
        "columns": {"hyponym":1, "hypernym":0, "distance":2},
        "transform": _distance_str_to_float,
        "description": "toy dataset (development set). n_sample=6543, distance=[-1,1,2,3]"
    },
    "hyponymy-triple-test": {
        ...
        "columns": {"hyponym":1, "hypernym":0, "distance":2},
        "transform": _distance_str_to_float,
        "description": "toy dataset (test set). n_sample=6544, distance=[-1,1,2,3]"
    }
}
